  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center relative overflow-hidden text-center px-4">
      ...
      <div className="relative z-10 max-w-2xl flex flex-col items-center">
        {/* Logo / Badge */}
        <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-primary text-white font-bold text-2xl shadow-[0_0_20px_rgba(88,101,242,0.4)] mb-6">
          CA
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-3 w-full max-w-md justify-center mb-12">
          <Button
            className="h-10 px-6 text-sm shadow-[0_0_15px_rgba(88,101,242,0.3)] hover:shadow-[0_0_25px_rgba(88,101,242,0.5)] transition-all flex items-center justify-center gap-2"
          ...
          <Button
            variant="outline"
            className="h-10 px-6 text-sm border-border hover:bg-surface/50 text-foreground"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full max-w-4xl mb-10">
          <div className="flex flex-col items-center p-5 bg-surface/30 border border-border rounded-xl hover:border-primary/30 transition-colors">
            ...
            <h3 className="text-sm font-bold text-foreground mb-1.5">Encuentra Grupos</h3>
            <p className="text-[12px] text-muted-foreground leading-relaxed">Matchmaking inteligente para conectar con líneas de investigación y laboratorios ideales para ti.</p>
          </div>
          <div className="flex flex-col items-center p-5 bg-surface/30 border border-border rounded-xl hover:border-primary/30 transition-colors">
            <div className="h-10 w-10 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center text-primary mb-3">
              <BookOpen className="w-5 h-5" />
            </div>
            <h3 className="text-sm font-bold text-foreground mb-1.5">Gestión de Tesis</h3>
            <p className="text-[12px] text-muted-foreground leading-relaxed">Guía administrativa paso a paso para la inscripción, desarrollo y sustentación de tu proyecto.</p>
          </div>
          <div className="flex flex-col items-center p-5 bg-surface/30 border border-border rounded-xl hover:border-primary/30 transition-colors">
            <div className="h-10 w-10 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center text-primary mb-3">
              <Scale className="w-5 h-5" />
            </div>
            <h3 className="text-sm font-bold text-foreground mb-1.5">Normativa Clara</h3>
            <p className="text-[12px] text-muted-foreground leading-relaxed">Respuestas precisas sobre convalidaciones, reglamentos y derechos estudiantiles.</p>
          </div>
        </div>

        {/* Contacto */}
        <div className="w-full max-w-2xl border-t border-border/50 pt-8 pb-6 flex flex-col items-center">
